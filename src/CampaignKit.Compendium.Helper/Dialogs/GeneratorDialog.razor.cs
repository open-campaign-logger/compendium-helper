// <copyright file="GeneratorDialog.razor.cs" company="Jochen Linnemann - IT-Service">
...
namespace CampaignKit.Compendium.Helper.Dialogs
{
    ...
    public partial class GeneratorDialog
    {
        ...
        /// </summary>
        [Inject]
        private ILogger<GeneratorDialog> Logger { get; set; }
        ...
        {
            this.Logger.LogInformation("Initializing GeneratorDialog component.");
